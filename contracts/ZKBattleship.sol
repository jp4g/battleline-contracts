...
contract ZKBattleship is IZKBattleship {
    ...
    function createGame(uint256 _board, bytes memory _proof)
        public
        override
        inactive
        returns (uint256)
    ...
    function joinGame(
        ...
        bytes memory _board,
        bytes memory _proof
    ) public override turn(_room) phaseRestrict(_room, Phase.Lobby) {}
    ...
    ) public override validCoordinates(_x, _y) turn(_room) {
